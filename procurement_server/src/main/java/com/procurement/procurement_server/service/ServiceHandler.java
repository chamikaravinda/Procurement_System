...
public class ServiceHandler {
	...
	public ResponseEntity handleServiceRequest(String reqId, Object obj, String uid) {
		...
		case CommonConstants.GET_SITE_BY_ID_REQUEST:
			return getSiteByID(uid);
		case CommonConstants.UPDATE_SITE_REQUEST:
			return updateSite((Site)obj);
	...
	private ResponseEntity updateSite(Site site) {
